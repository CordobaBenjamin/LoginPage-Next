...
const Terms = () => {
  ...
  return (
    <div className='block m-2 mb-5'>
        <div className='mb-5 '>
            <h2>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Accusamus tempora, necessitatibus, iure sequi odio repudiandae quas explicabo, est hic impedit labore temporibus optio natus quae voluptatum numquam dolor aliquid libero?</h2>
        </div>
