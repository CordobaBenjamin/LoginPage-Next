...
export const Country = () => {
    ...
    <div className='flex mx-auto'>   
        <div className='block m-2 mb-5 w-full'>
                ...
                <select id='country' className='mb-5 block border-b-2 border-gray-400 rounded bg-transparent w-full'{...register("country", {required: true, })}>
        ...
        <div className='block m-2 mb-5 w-full'>
                    ...
                    <>
                        ...
                        <input id='oth' type='Text' className='block border-b-2 border-gray-400 rounded bg-transparent w-full' placeholder='Put your country'/> 
                    ...
                    <>
                        ...
                        <select  className='block border-b-2 border-gray-400 rounded bg-transparent w-full' {...register("state", { required: true, })}>
                ...
                {/* //! MEXICO FORM */}
                    ...
                    <>
                        ...
                        <select id='state' className='block border-b-2 border-gray-400 rounded bg-transparent w-full'  {...register("state", { required: true, })}>
                ...
                {/* //! ARGENTINE FORM */}
                    ...
                    <>
                        ...
                        <select id='province'  className='block border-b-2 border-gray-400 rounded bg-transparent w-full' {...register("province", { required: true, })}>
                ...
                {/* //! JAPAN FORM */}
                    ...
                    <>
                        ...
                        <select id='district'  className='block border-b-2 border-gray-400 rounded bg-transparent w-full' {...register("district", { required: true, })}>
                ...
                {/* //! SPAIN FORM */}
                    ...
                    <>
                        ...
                        <select id='community'  className='block border-b-2 border-gray-400 rounded bg-transparent w-full ' {...register("community", { required: true, })}>
