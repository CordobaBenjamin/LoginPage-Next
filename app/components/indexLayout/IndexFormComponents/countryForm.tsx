  ...
  return (
    <div className="flex mx-auto">
      <div className="block m-2 mb-5 w-full">
        ...
        <select
          id="country"
          className="mb-5 block border-b-2 border-gray-400 rounded bg-transparent w-full"
      ...
      <div className="block m-2 mb-5 w-full">
        ...
        {watch("country") === "oth" && (
          <>
            <label htmlFor="oth" className="block">
              {" "}
              Other{" "}
            </label>
            <input
              id="oth"
              type="Text"
              className="block border-b-2 border-gray-400 rounded bg-transparent w-full"
        ...
        {watch("country") === "es" && (
          <>
            <label htmlFor="community" className="block">
              {" "}
